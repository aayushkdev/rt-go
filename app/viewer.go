...
func RunViewer(config Config) {
	...
	http.HandleFunc("/render", func(w http.ResponseWriter, r *http.Request) {
		cameraConfig := configFromRequest(r, config.Camera)
		img := renderer.RenderRGBA(camera.New(cameraConfig), world)
...
func configFromRequest(r *http.Request, base camera.Config) camera.Config {
